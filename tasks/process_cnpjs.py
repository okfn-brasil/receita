    ...
    if cursor is not None:
        ...
        if results is not None:
            ...
            for r in results:
                ...
                sql_insert = sql_insert + '\'' + str(campos_cnpj['estabelecimento_ddd_telefone_1']) + '\', '
                sql_insert = sql_insert + '\'' + str(campos_cnpj['estabelecimento_ddd_telefone_2']) + '\', '
                sql_insert = sql_insert + '\'' + str(campos_cnpj['estabelecimento_ddd_telefone_fax']) + '\', '
                ...
                sql_insert = sql_insert + campos_cnpj['empresa_codigo_natureza_juridica'] + ', '
                sql_insert = sql_insert + campos_cnpj['empresa_qualificacao_do_responsavel'] + ', '
